...
// Categories
define('_MI_SHOUTBOX_CAT1', '<span style="color: #FF0000; font-size: x-large;  font-weight: bold;">--- Global Settings ---</span> ');
define('_MI_SHOUTBOX_CAT2', '<span style="color: #FF0000; font-size: x-large;  font-weight: bold;">--- Block Settings ---</span> ');
define('_MI_SHOUTBOX_CAT3', '<span style="color: #FF0000; font-size: x-large;  font-weight: bold;">--- PopUp Settings ---</span> ');
define('_MI_SHOUTBOX_CAT4', '<span style="color: #FF0000; font-size: x-large;  font-weight: bold;">--- Text Input Settings ---</span> ');
...
define('_MI_SHOUTBOX_DESC19', '<table><tr>
                               ...
                               <td><img src="' . XOOPS_URL . '/modules/shoutbox/assets/images/guestavatars/guest4.gif" width=60></td>
                               <td><img src="' . XOOPS_URL . '/modules/shoutbox/assets/images/guestavatars/guest5.gif" width=60></td>
                               </tr><tr>
                               <td>guest1</td>
                               <td>guest2</td>
                               <td>guest3</td>
...
//define('_MI_SHOUTBOX_HELP_DIR', __DIR__);
